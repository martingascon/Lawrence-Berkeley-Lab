...
#define XHL 700		// before was 230 and 950 resp
...
Int_t k, N=10000,empts=0,qepts=0,napts=0,phsample=1,phNaI=0,n=0;
Float_t x[N],y[N]; 	
Float_t xb[N],yb[N],xc[N],yc[N],yn[N];
Float_t norm=1,norm2=1,norm3=1,area1=0,area2=0,area3=0;


char file[100],file2[200],file3[200],scint[100]="",sample[100]="00000",dopant[100]="";
...
switch (argc)
	...
	case 4: sprintf(file,"%s.txt",argv[1]);                	// EMISSION FROM htcf viewer
		...
		phsample=atoi(argv[3]);				// PHM photopeak channel of the file		
		break;
	default:
		MsgError();
		exit(1);
...
//sprintf(file3,"/home/martin/Downloads/25001_XRL.txt");   
sprintf(file3,"/home/martin/misProgs/cc3/support_files/13144_XRL.txt");   
//sprintf(file3,"/home/martin/Dropbox/a_LBNL/b_PHM/l_dec_2013/dec04_SrI2_Capesym/LYcalc/13169_Lu2O5Si1_XRL_09_21_2012.txt"); //LSO 
//sprintf(file3,"/home/martin/Dropbox/a_LBNL/b_PHM/l_dec_2013/dec04_SrI2_Capesym/LYcalc/13169_Lu2O5Si1_XRL_09_21_2012.txt"); //   
//sprintf(file3,"/home/martin/Dropbox/a_LBNL/b_PHM/l_dec_2013/dec04_SrI2_Capesym/LYcalc/19934_Bi4Ge3O12_XRL_08_10_2011.txt"); //bgo
//sprintf(file3,"/home/martin/Dropbox/a_LBNL/b_PHM/l_dec_2013/dec04_SrI2_Capesym/LYcalc/7870-Al5Lu3O12-1Pr-XRL-05_23_2007.txt"); //LuAG(Pr) 1
//sprintf(file3,"/home/martin/Dropbox/a_LBNL/b_PHM/l_dec_2013/dec04_SrI2_Capesym/LYcalc/11076-Al5Lu3O12-0_2Pr3-XRL-02_28_2008.txt"); //LuAG(Pr)2
//sprintf(file3,"/home/martin/Dropbox/a_LBNL/b_PHM/l_dec_2013/dec04_SrI2_Capesym/LYcalc/13140-Al5O12Y3-XRL-07_08_2010.txt"); //LSO       
...
/*
PrintLatex2(Form("LSO"),0.60,0.85,kGreen+3);
PrintLatex2(Form("SrI_{2}(Eu)"),0.60,0.80,2);
PrintLatex2(Form("PMT QE"),0.60,0.75,kBlue);
PrintLatex2(Form("SrI_{2}(Eu) x QE"),0.60,0.70,kMagenta+2);
PrintLatex2(Form("LSO x QE"),0.60,0.65,kCyan+2);
*/

PrintLatex2(Form("NaI(Tl)"),0.60,0.85,kGreen+3);
PrintLatex2(Form("sample)"),0.60,0.80,2);
PrintLatex2(Form("PMT QE"),0.60,0.75,kBlue);
PrintLatex2(Form("sample x QE"),0.60,0.70,kMagenta+2);
...
Float_t Area_ratio=0,lysample=0,lyNaI=44000;


Area_ratio = lo1tot/lo2tot;
lysample= phsample/Area_ratio/phNaI*lyNaI;

cout << "******************* SUMMARY ****************" <<endl;
cout << "Considering that NaI(Tl) has " << lyNaI <<" ph/MeV" <<endl;
cout << "and the Photopeak of NaI(Tl) is around channel " << phNaI <<endl;
cout << "your crystal yield is: "<< lysample << " ph/MeV" <<endl;
cout << "****************************************************" <<endl;
...
PrintLatex2(Form("LY = %2.0f%s",lysample," ph/MeV"),0.6,0.4,kRed);
