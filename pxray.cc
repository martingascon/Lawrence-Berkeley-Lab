...
Float_t minx, maxx; 		      
Char_t f1[100],f2[100],scint[100]="NaI",sample[100]="00000",title[100]="",*dopant;
...
if(!*in){
	...
	*in >> ci; *in >> ci;*in >> ci; *in >> ci;*in >> ci; *in >> ci;*in >> ci; // removes the header
	...
	TGraph *gr1 = new TGraph(nsteps,x,y);			 
	gr1->SetLineColor(2);					
	gr1->SetLineWidth(2);				 
...
if(!*in2){
	...
	*in2 >> ci; *in2 >> ci;*in2 >> ci; *in2 >> ci;*in2 >> ci; *in2 >> ci;*in2 >> ci; // removes the header
	...
	TGraph *gr2 = new TGraph(nsteps,x,y);			 
	gr2->SetLineColor(4);					
	gr2->SetLineWidth(2);				 
