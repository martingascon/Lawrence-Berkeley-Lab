...
Char_t f1[100],f2[100],f3[100],f4[100],f5[100],f6[100],scint[100]="",sample[100]="00000",dopant[100]="";
...
if (argc>1)
	...
	Plot_XRL(gr1,1,2);
	PrintLatex2(Form("%s:%s",scint,dopant),0.50,0.85,2);
	}
...
if (argc>2)
	...
	Plot_XRL(gr2,0,4);
	PrintLatex2(Form("%s:%s",scint,dopant),0.50,0.80,4);
	}
...
if (argc>3)
	...
	Plot_XRL(gr3,0,8);
	PrintLatex2(Form("%s:%s",scint,dopant),0.50,0.75,8);
	}
...
if (argc>4)
	...
	Plot_XRL(gr4,0,1);
	PrintLatex2(Form("%s:%s",scint,dopant),0.50,0.70,1);
	}
...
if (argc>5)
	...
	Plot_XRL(gr5,0,6);
	PrintLatex2(Form("%s:%s",scint,dopant),0.50,0.65,6);
	}
