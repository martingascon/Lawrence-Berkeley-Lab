...
char title[100]="title",file[100],file2[100],xaxis[100]="Wavelength (nm)",yaxis[100]="Intensity (a.u.)";
...
if (col==2)
	...
	gr0->Draw("AL");
  	PrintLatex2(Form("Serie 1"),0.50,0.85,2);
	}
...
if (argc==6||argc>7)
{
	...
	if (col3==2)
		...
		PrintLatex2(Form("Serie 3"),0.50,0.75,kGreen+3);
		gr0c->Draw("Lsame");
		}
	...
	if (col4==2)
		...
		gr0d->GetYaxis()->CenterTitle();	
 		PrintLatex2(Form("Serie 4"),0.50,0.70,kOrange+2);
		gr0d->Draw("samel");
		}
